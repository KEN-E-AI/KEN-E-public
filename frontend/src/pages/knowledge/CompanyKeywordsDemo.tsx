    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">
          Compare the original and paginated versions of the company keywords configuration.
        </p>
      </div>
      ...
      <Alert>
        ...
        <AlertDescription>
          The paginated version is recommended for accounts with 100+ keywords. It provides better
          performance, search functionality, and a cleaner user experience for large datasets.
        </AlertDescription>
      </Alert>
      ...
      <Tabs defaultValue="paginated" className="space-y-4">
        <TabsList className="grid w-full grid-cols-2">
          ...
          <TabsTrigger value="paginated">Paginated Version (Recommended)</TabsTrigger>
        </TabsList>
        ...
        <TabsContent value="original" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Displays all keywords at once. May experience performance issues with large datasets.
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="paginated" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Displays keywords in pages with search and configurable page size.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2 text-sm">
        ...
        <CardContent className="space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
              <li>The paginated version renders only visible keywords, reducing DOM size</li>
              <li>Search is performed server-side, reducing client processing</li>
              <li>Page size can be adjusted based on user preference and device capabilities</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
              <li>Keywords are added/removed immediately without a separate save step</li>
          ...
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground">
              <li>New endpoint: GET /monitoring-topics/{'{account_id}'}/company/paginated</li>

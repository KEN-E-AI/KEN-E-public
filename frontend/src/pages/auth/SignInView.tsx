...
export function SignInView({
  ...
  const createAccountHref = invitationToken
    ? `/create-account?${new URLSearchParams({ invitation: invitationToken }).toString()}`
    : "/create-account";
      ...
      <div className="w-full max-w-md animate-page-enter">
        ...
        <div className="bg-card rounded-[var(--radius-lg)] border-2 border-[var(--color-border-default)] p-6 shadow-lg">
          ...
          <form onSubmit={onSubmit} className="space-y-4">
            ...
            <Button
              type="submit"
              className="w-full gap-2 bg-[#F97066] hover:bg-[#e85f55] text-[var(--color-text-primary)] dark:text-[var(--color-text-inverse)] transition-all duration-200 hover:-translate-y-0.5 hover:rotate-[-1deg]"

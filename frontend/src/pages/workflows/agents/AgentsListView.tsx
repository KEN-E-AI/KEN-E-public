...
function CardSkeleton() {
  return (
    <div className="p-4 rounded-[0.875rem] border-2 border-[var(--color-border-default)] bg-card flex flex-col">
      {/* Top row — badge + gear */}
      <div className="flex items-center justify-end gap-2 mb-2">
        <Skeleton className="h-4 w-16 rounded-full" />
        <Skeleton className="size-7 rounded-[var(--radius-sm)]" />
      </div>
      {/* Two-column body — circular icon + stacked text */}
      <div className="flex items-center gap-3 mb-3">
        <Skeleton className="size-[5.5rem] rounded-full shrink-0" />

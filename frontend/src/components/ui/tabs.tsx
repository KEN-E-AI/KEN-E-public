...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "data-[state=active]:bg-[var(--color-teal-500)] data-[state=active]:text-[var(--color-text-inverse)] data-[state=active]:border-[var(--color-teal-500)] data-[state=active]:shadow-color-teal",

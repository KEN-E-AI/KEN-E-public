...
/**
 * Industry selector with search functionality - uses native dropdown positioning
 * This version fixes scrolling issues with Radix UI Popover
 */
export const IndustrySelectDropdown = React.forwardRef<
  HTMLButtonElement,
  IndustrySelectProps
>(
  (
...
IndustrySelectDropdown.displayName = "IndustrySelectDropdown";

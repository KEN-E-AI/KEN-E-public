...
// The "Customer Region" Figma surface is a single select; the Account model
// stores `region` as an array. This surface edits the primary region — values
// match the account-creation wizard's region scheme.
          ...
          <Card className="p-6 border-amber-500/50">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Move this account to a different organization. This cannot be
                  undone.
                </p>
              </div>
            </div>
          ...
          <Card className="p-6 border-destructive/50">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Permanently delete this account and all its data. This action
                  cannot be undone.
                </p>
              </div>
            </div>

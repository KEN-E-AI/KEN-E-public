// TODO(CH-PRD-02): replace stub with real chat-session-history integration.
// Visual shell ported verbatim from docs/figma-export/src/app/components/SessionsSidebar.tsx
// so CH-PRD-02 can replace internals (session selection, search, categories,
// real chat history) in place without moving the file. Lives in components/chat/
// (not components/layout/) because UI-PRD-01 §2 assigns SessionsSidebar to the Chat
// component.

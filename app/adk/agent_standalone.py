...
def dispatch_to_strategy(
    ...
    try:
        ...
        try:
            ...
            from agents.strategy_agent.firestore import initialize_firestore as utils_init
            from agents.strategy_agent.firestore import initialize_firestore as context_init

    ...
    def get_previous_outputs(self, for_agent: str) -> Dict[str, Any]:
        ...
        if for_agent == "competitive_strategy":
            ...
            if self.business_strategy:
                outputs.update(
                    {
                        "business_strategy.businessStrategySummary": self.business_strategy.get(
                            "businessStrategySummary"
                        ),
                        "business_strategy.companyOverview": self.business_strategy.get(
                            "companyOverview"
                        ),
                        "business_strategy.marketAndIndustryAnalysis": self.business_strategy.get(
                            "marketAndIndustryAnalysis"
                        ),
                        "business_strategy.productsAndServices": self.business_strategy.get(
                            "productsAndServices"
                        ),
                        "business_strategy.marketingAndCustomerStrategy": self.business_strategy.get(
                            "marketingAndCustomerStrategy"
                        ),
                        "business_strategy.swotAnalysis": self.business_strategy.get(
                            "swotAnalysis"
                        ),
                    }
                )
            ...
            if self.competitive_strategy:
                outputs.update(
                    {
                        "competitive_strategy.competitiveLandscape": self.competitive_strategy.get(
                            "competitiveLandscape"
                        ),
                        "competitive_strategy.competitiveStrategySummary": self.competitive_strategy.get(
                            "competitiveStrategySummary"
                        ),
                        "competitive_strategy.strategicRecommendations": self.competitive_strategy.get(
            ...
            if self.customer_strategy:
                outputs.update(
                    {
                        "customer_strategy.customerProfiles": self.customer_strategy.get(
                            "customerProfiles"
                        ),
                        "customer_strategy.customerJourneyMaps": self.customer_strategy.get(
                            "customerJourneyMaps"
                        ),
                        "customer_strategy.personaInsights": self.customer_strategy.get(
                            "personaInsights"
                        ),
                    }
                )
            ...
            if self.marketing_strategy:
                outputs.update(
                    {
                        "marketing_strategy.channelStrategies": self.marketing_strategy.get(
                            "channelStrategies"
                        ),
                        "marketing_strategy.campaignPlans": self.marketing_strategy.get(
                            "campaignPlans"
                        ),
                        "marketing_strategy.messagingFramework": self.marketing_strategy.get(
                            "messagingFramework"
                        ),
                    }
                )

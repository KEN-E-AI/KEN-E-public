...
class BrandGraphBuilder:
    ...
    def _create_brand_identity(self, guidelines: BrandGuidelines, account_id: str) -> Dict:
        ...
        node = self.neo4j_ops.create_strategy_node('BrandIdentity', node_data, account_id)
    ...
    def _create_brand_personality(self, description: str, brand_identity_id: str, account_id: str) -> Dict:
        ...
        node = self.neo4j_ops.create_strategy_node('BrandPersonality', node_data, account_id)
        ...
        """
        self.neo4j_ops.connection.execute_query(query, {
            'brand_id': brand_identity_id,
            'personality_id': node_id
        })

        return node_data

    def _create_voice_and_tone(self, description: str, brand_identity_id: str, account_id: str) -> Dict:
        ...
        node = self.neo4j_ops.create_strategy_node('VoiceAndTone', node_data, account_id)
    ...
    def _create_color_palette(self, description: str, brand_identity_id: str, account_id: str) -> Dict:
        ...
        node = self.neo4j_ops.create_strategy_node('ColorPalette', node_data, account_id)
    ...
    def _create_typography(self, description: str, brand_identity_id: str, account_id: str) -> Dict:
    ...
    def _create_image_style(self, description: str, brand_identity_id: str, account_id: str) -> Dict:
    ...
    def _create_mission_and_values(self, description: str, brand_identity_id: str, account_id: str) -> Dict:
        ...
        node = self.neo4j_ops.create_strategy_node('MissionAndValues', node_data, account_id)

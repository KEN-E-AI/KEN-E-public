...
class EnhancedJsonParser:
    ...
    def parse_json(
        self, raw_output: str, schema: type[BaseModel] | None = None
    ) -> dict[str, Any]:
        """
    ...
    def _parse_with_enhanced(
        ...
        try:
            ...
            content = re.sub(
                r"([\{,]\s*)([a-zA-Z_][a-zA-Z0-9_]*)(\s*:)", r'\1"\2"\3', content
            )
            ...
            logger.warning(
                f"All parsing strategies failed. Content preview: {content[:200]}..."
            )
            return None
...
_parser_instance: EnhancedJsonParser | None = None

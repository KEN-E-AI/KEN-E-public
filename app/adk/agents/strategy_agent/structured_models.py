...
class ProductCategory(BaseModel):
    ...
    value_propositions: List[ValueProposition] = Field(..., description="The core value propositions delivered by products in this category")
...
class MarketSize(BaseModel):
    ...
    source: Optional[str] = Field(None, description="The source of the market size data")
...
class RevenueStream(BaseModel):
    ...
    id: str = Field(..., description="A unique identifier (e.g., 'revstream-subscriptions')")
...
class MarketAndIndustryAnalysis(BaseModel):
    ...
    market_description: str = Field(..., description="A narrative overview of the industry where the company competes")
    total_addressable_market: Optional[MarketSize] = None
...
class StrategyUpdateRequest(BaseModel):
    ...
    update_trigger: str = Field(..., description="What triggered this update (e.g., 'market_change', 'user_request', 'competitor_action')")
    target_sections: List[str] = Field(..., description="Which sections need updating")
    update_context: Dict[str, Any] = Field(..., description="Additional context for the update")
    user_id: Optional[str] = Field(None, description="User requesting the update")
...
class StrategyVersion(BaseModel):
    ...
    deltas: List[StrategyDelta] = Field(..., description="List of all changes in this version")
...
class SimpleBusinessStrategy(BaseModel):
    ...
    businessStrategySummary: str = Field(..., description="Executive summary of the business strategy")
    companyOverview: str = Field(..., description="Comprehensive overview of the company")

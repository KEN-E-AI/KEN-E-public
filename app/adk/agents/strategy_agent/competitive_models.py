...
class StrengthWithRisks(BaseModel):
    ...
    references: list[str] = Field(
        default=[],
        description="Source URLs where information about this strength was found during research",
    )
...
class WeaknessWithOpportunities(BaseModel):
    ...
    references: list[str] = Field(
        default=[],
        description="Source URLs where information about this weakness was found during research",
    )
...
class Competitor(BaseModel):
    ...
    references: list[str] = Field(
        default=[],
        description="Source URLs where information about this competitor was found during research",
    )

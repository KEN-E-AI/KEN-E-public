...
from app.adk.agents.strategy_agent.models import StrategyContext, StrategyGenerationRequest
...
class TestEventProcessingIntegration:
    ...
    def test_process_multi_agent_event_stream(self):
        ...
        assert result['business_strategy']['businessStrategySummary'] == "We provide AI solutions"
    ...
    def test_handles_malformed_events_gracefully(self):
        ...
        valid_event.actions.state_delta = {
            'updated_strategy_doc': '{"valid": "data"}'
        }
...
```'''
        ...
        assert parsed["businessStrategySummary"] == "We are a technology company focused on AI\\sinnovation"
...
class TestEndToEndScenarios:
    ...
    def test_partial_execution_recovery(self):
        ...
        events = []
        for agent_name in ["business_strategy_agent", "competitive_strategy_agent", "customer_strategy_agent"]:
            event = Mock()

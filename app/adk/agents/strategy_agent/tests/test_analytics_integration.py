...
class TestOptimizationRecommendations:
    ...
    def test_model_downgrade_recommendation(self, mock_firestore):
        ...
        model_recs = [r for r in recommendations if r.recommendation_type == "model_downgrade"]
    ...
    def test_context_optimization_recommendation(self, mock_firestore):
        ...
        context_recs = [r for r in recommendations if r.recommendation_type == "context_reduction"]

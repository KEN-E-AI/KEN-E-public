...
class TestCreateStrategySequentialAgent:
    ...
    @patch('app.adk.agents.strategy_agent.orchestrator.create_competitive_strategy_agent')
    ...
    def test_agent_creation_order_matters(self):
        ...
        with patch('app.adk.agents.strategy_agent.orchestrator.SequentialAgent') as mock_seq:
            with patch('app.adk.agents.strategy_agent.orchestrator.create_business_strategy_agent') as mock_b:
                with patch('app.adk.agents.strategy_agent.orchestrator.create_competitive_strategy_agent') as mock_c:
                    context = StrategyContext(
                        account_id="test",
                        company_name="Test",
                        websites=["https://test.com"],
...
class TestExecuteStrategyGeneration:
    ...
    @patch('app.adk.agents.strategy_agent.orchestrator.create_strategy_sequential_agent')
    ...
    def test_execution_with_injected_client(self, mock_firestore_client_class):
        ...
        with patch('app.adk.agents.strategy_agent.orchestrator.create_strategy_sequential_agent'):
            with patch('app.adk.agents.strategy_agent.orchestrator.Runner'):
                with patch('app.adk.agents.strategy_agent.orchestrator.process_and_save_documents'):
                    result = execute_strategy_generation(
                        company_name="Test",
                        industry="Tech",
                        websites="https://test.com",
...
class TestProcessAndSaveDocuments:
    ...
    def test_continues_on_firestore_save_failure(self):
        ...
        event.actions.state_delta = {
            'updated_strategy_doc': '{"test": "data"}'
        }
...
class TestParseDocumentFromEvent:
    ...
    def test_parses_json_string_and_determines_type(self):
        ...
        doc_content = '{"businessStrategySummary": "Test", "companyOverview": "Overview"}'

...
class TestFirestoreRetryDecorator:
    ...
    def test_non_retriable_exception_no_retry(self):
        ...
        mock_func = Mock(
            side_effect=google_exceptions.InvalidArgument("Bad request")
        )
    ...
    def test_operation_name_in_logs(self, caplog):
        ...
        assert "test_operation failed on attempt 1" in caplog.text or "test_operation succeeded on attempt 2" in caplog.text

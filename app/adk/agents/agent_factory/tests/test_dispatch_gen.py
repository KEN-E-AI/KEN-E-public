...
# ---------------------------------------------------------------------------
# TestDelegateToSpecialist deleted in AH-75 — delegate_to_specialist was a
# function-tool dispatch surface. Approach 1 replaces it with ADK's native
# transfer_to_agent + dynamically-attached sub_agents (sub_agent_attacher).
# See test_sub_agent_attacher.py and the rebuilt parity-test Mode B helper.
# ---------------------------------------------------------------------------

...
def test_cli_functionality():
    ...
    try:
        ...
        console.print(f"✓ Found {len(insights)} insights and {len(intuitions)} intuitions")
        ...
        console.print("[dim]Run 'uv run python cli_manager.py' to start the interactive CLI[/dim]")

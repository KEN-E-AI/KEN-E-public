...
async def test_agents():
    ...
    if ken_e_id:
        print(f"✅ KEN_E_ENGINE_ID loaded from Secret Manager")
    ...
    if strategy_id:
        print(f"✅ STRATEGY_SUPERVISOR_ENGINE_ID loaded from Secret Manager")
    ...
    if wandb_key:
        print(f"✅ WANDB_API_KEY loaded from Secret Manager")
    ...
    try:
        ...
        if ken_e_id:
            try:
                print(f"Connecting to KEN-E agent...")
                ken_e_agent = reasoning_engines.ReasoningEngine(ken_e_id)
                print(f"✅ Successfully connected to KEN-E agent")
        ...
        if strategy_id:
            try:
                ...
                print(f"✅ Successfully connected to Strategy Supervisor")
            except Exception as e:

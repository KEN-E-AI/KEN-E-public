"""Per-session sliding-window rate limiter for category assignment operations.
...
class CategoryAssignRateLimiter:
        ...
        with self._lock:
            ...
            if len(bucket) >= self.max_requests:
                ...
                raise HTTPException(
                    ...
                    detail=(
                        f"Rate limit exceeded: {self.max_requests} category-assign "
...
category_assign_limiter = CategoryAssignRateLimiter()

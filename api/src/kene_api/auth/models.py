...
class UserContext:
    ...
    account_permissions: dict[str, str] = field(default_factory=dict)  # account_id -> edit|view (for view-role users only)
    ...
    def has_account_access(self, account_id: str, required_roles: list[str] | None = None) -> bool:
        ...
        has_admin_access = any(role == "admin" for role in self.organization_permissions.values())
        if has_admin_access:
            return True
    ...
    def has_account_permission(self, account_id: str, organization_id: str, required_level: str = "view") -> bool:
    ...
    def has_organization_permission(self, organization_id: str | None = None, required_role: str = "view") -> bool:
    ...
    def get_effective_account_role(self, account_id: str, organization_id: str | None = None) -> str | None:
        ...
        if organization_id and self.organization_permissions.get(organization_id) == "admin":
            return "edit"

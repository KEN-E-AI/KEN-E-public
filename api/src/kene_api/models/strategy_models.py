...
class StrategyDocument(BaseModel):
    ...
    doc_type: Literal["business_strategy", "competitive_strategy", "customer_strategy", "marketing_strategy", "measurement_plan", "brand_strategy"] = Field(
        ..., description="Type of strategy document"
    )
    content: Dict[str, Any] = Field(..., description="Document content following best practices schema")
...
class StrategyAuditEntry(BaseModel):
    ...
    # Change tracking
    changes: Optional[Dict[str, Any]] = Field(default=None, description="Before/after for updates")
    fields_modified: Optional[List[str]] = Field(default=None, description="List of modified fields")
    
    # Session tracking
    session_id: Optional[str] = Field(default=None, description="Chat session ID if from chatbot")
    request_id: Optional[str] = Field(default=None, description="API request ID for tracing")
...
class StrategyDocumentResponse(BaseModel):
    ...
    access_level: Literal["view", "edit", "admin"] = Field(..., description="User's access level")
...
class StrategyDocumentListResponse(BaseModel):
    ...
    documents: List[StrategyDocument] = Field(..., description="List of strategy documents")
...
class StrategyTemplateResponse(BaseModel):
    ...
    doc_type: str = Field(..., description="Type of strategy document")
    template: Dict[str, Any] = Field(..., description="Template or best practices schema")
    guidelines: Optional[str] = Field(default=None, description="Reviewer guidelines")
    examples: Optional[List[Dict[str, Any]]] = Field(default=None, description="Example documents")
...
class StrategyGenerationRequest(BaseModel):
    ...
    doc_type: Literal["business_strategy", "competitive_strategy", "customer_strategy", "marketing_strategy", "measurement_plan", "brand_strategy"] = Field(
        ..., description="Type of strategy document to generate"
    )
    ...
    existing_document_id: Optional[str] = Field(
...
class StrategyGenerationResponse(BaseModel):
    ...
    document: Optional[StrategyDocument] = Field(default=None, description="Generated document")

...
def hash_bucket(flag_key: str, entity_id: str) -> int:
    ...
    base-16, reduced modulo 100.  This algorithm is pinned by PRD §4 — any
    change to the byte sequence or modulus breaks cross-process determinism and
    silently shuffles users between rollout cohorts.
    ...
    string) — never an email address or any PII-bearing field (README §7.3).
    """

        ...
        try:
            ...
            if current is None:
                ...
                if success:
                    ...
                    logger.warning(
                        f"Could not set rate limit for {key}, allowing request"
                    )
                    return True, None
            ...
            if current_count >= max_requests:
                ...
                try:
                    ...
                    logger.warning(
                        f"Rate limit exceeded for {key}: {current_count}/{max_requests}"
                    )
                    return False, ttl
                except Exception:
...
class APIRateLimiter:
    ...
    async def check_wikipedia_limit(self, term: str) -> tuple[bool, str | None]:
    ...
    async def check_wikidata_limit(self, term: str) -> tuple[bool, str | None]:
    ...
    async def check_gemini_limit(self, term: str) -> tuple[bool, str | None]:

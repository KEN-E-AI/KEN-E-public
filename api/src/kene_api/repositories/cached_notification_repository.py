...
class CachedNotificationRepository(NotificationRepository):
    ...
    def __init__(self, repository: NotificationRepository, cache_ttl: int = 300):
        ...
        # In-memory caches
        self._preferences_cache: dict[str, tuple[UserNotificationPreferences | None, float]] = {}
    ...
    async def update_user_status(
        ...
        keys_to_remove = [k for k in self._unread_count_cache if k.startswith(f"{user_id}:")]

...
def test_model_structure():
    ...
    try:
        ...
        assert 'superset_metric_id' not in metric_fields  # Should not be in model anymore
        ...
        assert 'superset_metric_id' not in request_fields  # Should not be in model anymore

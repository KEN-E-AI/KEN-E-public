...
class KeneAPIClient:
    ...
    def get_kpi_setting(
        ...
        return self._make_request(
            "GET",
            f"{self.FIRESTORE_KPI_ENDPOINT}/{organization_id}/{account_id}/{kpi_name}",
        )
    ...
    def get_funnel_steps(
        ...
        return self._make_request(
            "GET",
            f"{self.FIRESTORE_FUNNEL_STEPS_ENDPOINT}/{organization_id}/{account_id}/{funnel_type}{params}",
        )
    ...
    def get_funnel_step(
        ...
        return self._make_request(
            "GET",
            f"{self.FIRESTORE_FUNNEL_STEPS_ENDPOINT}/{organization_id}/{account_id}/{funnel_type}/{funnel_step_num}{params}",
        )
    ...
    def create_channel(
        ...
        return self._make_request(
            "POST",
            f"{self.FIRESTORE_CHANNELS_ENDPOINT}/{organization_id}{params}",
            json=data,
        )
    ...
    def get_channels(
        ...
        if big_bet_name:
            params += f"&big_bet_name={big_bet_name}"
        return self._make_request(
            "GET", f"{self.FIRESTORE_CHANNELS_ENDPOINT}/{organization_id}{params}"
        )
    ...
    def get_channel(
        ...
        return self._make_request(
            "GET",
            f"{self.FIRESTORE_CHANNELS_ENDPOINT}/{organization_id}/{channel_name}{params}",
        )
    ...
    def create_tactic(
        ...
        return self._make_request(
            "POST",
            f"{self.FIRESTORE_TACTICS_ENDPOINT}/{organization_id}{params}",
            json=data,
        )
    ...
    def get_tactics(
        ...
        if big_bet_name:
            params += f"&big_bet_name={big_bet_name}"
        return self._make_request(
            "GET", f"{self.FIRESTORE_TACTICS_ENDPOINT}/{organization_id}{params}"
        )
    ...
    def get_tactic(
        ...
        return self._make_request(
            "GET",
            f"{self.FIRESTORE_TACTICS_ENDPOINT}/{organization_id}/{tactic_name}{params}",
        )
...
class KeneCLI:
    ...
    NO_ACTIVITIES_FOUND = (
        "[yellow]No activities found. Create activities first.[/yellow]"
    )
    ...
    def run(self):
        ...
        self.organization_id = Prompt.ask("Enter organization ID", default="org001")
        self.account_id = Prompt.ask("Enter account ID", default="a000001")
    ...
    def _show_activities_menu(self) -> str:
        ...
        return Prompt.ask(
            self.CHOOSE_OPTION_PROMPT, choices=["1", "2", "3", "4", "5", "6"]
        )
    ...
    def _edit_activity(self):
        ...
        data = {
            ...
            "activity_description": Prompt.ask(
                "Activity description", default=activity.get("activity_description", "")
            ),
            "expected_impact": Prompt.ask(
                "Expected impact", default=activity.get("expected_impact", "")
            ),
            "internal": Confirm.ask(
                "Is this an internal activity?", default=activity.get("internal", False)
            ),
    ...
    def _delete_activity(self):
        ...
        if Confirm.ask("Are you sure you want to delete this activity?"):
            data = {"account_id": self.account_id, "id": activity_id}
    ...
    def _view_activity_logs(self):
        ...
        for activity in activities:
            ...
            for log in logs:
                log["parent_activity_description"] = activity.get(
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                ...
                self.client._make_request(
                    "POST", self.ACTIVITIES_LOGS_ENDPOINT, json=data
                )
    ...
    def _edit_activity_log(self):
        ...
        choice = Prompt.ask(
            self.ENTER_LOG_NUMBER, choices=[str(i) for i in range(1, len(all_logs) + 1)]
        )
        ...
        start_date = Prompt.ask(
            "Start date (YYYY-MM-DD)", default=selected_log.get("start_date", "")
        )
        end_date = Prompt.ask(
            "End date (YYYY-MM-DD)", default=selected_log.get("end_date", "")
        )
        description = Prompt.ask(
            "Description", default=selected_log.get("description", "")
        )
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                # Use the activities endpoint for logs
                self.client._make_request(
                    "PUT", self.ACTIVITIES_LOGS_ENDPOINT, json=data
                )
    ...
    def _delete_activity_log(self):
        ...
        if Confirm.ask("Are you sure you want to delete this activity log?"):
            data = {"account_id": self.account_id, "id": log_id}

            try:
                # Use the activities endpoint for logs
                self.client._make_request(
                    "DELETE", self.ACTIVITIES_LOGS_ENDPOINT, json=data
                )
    ...
    def _add_metric(self):
        ...
        metric_name = Prompt.ask(
            "Metric name (snake_case, required)",
            default=verbose_name.lower().replace(" ", "_"),
        )
    ...
    def _get_metric_field_values(self, metric, metric_id):
        ...
        verbose_name = Prompt.ask(
            "Verbose name", default=metric.get("verbose_name", "")
        )
    ...
    def _delete_metric(self):
        ...
        if Confirm.ask("Are you sure you want to delete this metric?"):
            data = {"account_id": self.account_id, "id": metric_id}
    ...
    def _display_insights_table(self, insights):
        ...
        for insight in insights:
            ...
            activity_log_id = self._truncate_string(
                insight.get("activity_log_id", "N/A"), 15
            )
            metric_name = self._truncate_string(
                insight.get("metric_verbose_name", "N/A"), 25
            )
        ...
        try:
            ...
            if isinstance(evidence, dict):
                if "active_evidence" in evidence:
                    active_conf = evidence["active_evidence"].get(
                        "active_confidence", "N/A"
                    )
                if "influence_evidence" in evidence:
                    influence_likely = str(
                        evidence["influence_evidence"].get("influence_likely", "N/A")
                    )
            elif hasattr(evidence, "active_evidence") and hasattr(
    ...
    def _add_insight(self):
        ...
        console.print(
            "Insights link ActivityLog entries to Metrics, showing confirmed influence."
        )
    ...
    def _select_activity_log(self):
        ...
        choice = Prompt.ask(
            self.ENTER_ACTIVITY_NUMBER, choices=list(activity_choices.keys())
        )
    ...
    def _create_evidence_data(self, relationship_type="INFLUENCE_CONFIRMED"):
        ...
        evidence_description = Prompt.ask("Evidence description (optional)", default="")
        ...
        if relationship_type == "INFLUENCE_CONFIRMED":
            influence_aligned = Confirm.ask(
                "Is the influence direction aligned with expectations?", default=True
            )
    ...
    def _add_intuition(self):
        ...
        console.print(
            "Intuitions link Activities directly to Metrics, showing likely influence."
        )
    ...
    def _view_kpi_settings(self):
        ...
        try:
            result = self.client.get_all_kpi_settings(
                self.organization_id, self.account_id
            )
            if result.get("success"):
                ...
                console.print(
                    f"[red]Error: {result.get('detail', 'Unknown error')}[/red]"
                )
        except Exception as e:
    ...
    def _update_kpi_setting(self):
        ...
        kpi_name = Prompt.ask(
            "KPI Name", choices=["income_kpi", "marketing_cost_kpi", "net_income_kpi"]
        )
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to update KPI setting: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _view_funnel_steps(self):
        ...
        try:
            result = self.client.get_funnel_steps(
                self.organization_id, self.account_id, funnel_type, big_bet_name
            )
            if result.get("success"):
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to create funnel step: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _edit_funnel_step(self):
        ...
        # Get current data
        try:
            current_result = self.client.get_funnel_step(
        ...
        efficiency_kpi = Prompt.ask(
            "Efficiency KPI (Metric ID)", default=current_data.get("efficiency_kpi", "")
        )
        objective = Prompt.ask("Objective", default=current_data.get("objective", ""))
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                result = self.client.update_funnel_step(
                    self.organization_id,
                    self.account_id,
                    funnel_type,
                    funnel_step_num,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to update funnel step: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _delete_funnel_step(self):
        ...
        if Confirm.ask("Are you sure you want to delete this funnel step?"):
            try:
                result = self.client.delete_funnel_step(
                    self.organization_id,
                    self.account_id,
                    funnel_type,
                    funnel_step_num,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to delete funnel step: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
                ...
                if channels:
                    ...
                    for channel in channels:
                        supporting_metrics = ", ".join(
                            channel.get("supporting_metrics", [])
                        )
                        table.add_row(
    ...
    def _add_channel(self):
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                result = self.client.create_channel(
                    self.organization_id,
                    data,
                    self.account_id,
                    funnel_type,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to create channel: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _edit_channel(self):
        ...
        # Get current data
        try:
            current_result = self.client.get_channel(
                self.organization_id,
                channel_name,
                self.account_id,
                funnel_type,
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                result = self.client.update_channel(
                    self.organization_id,
                    channel_name,
                    data,
                    self.account_id,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to update channel: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _delete_channel(self):
        ...
        if Confirm.ask("Are you sure you want to delete this channel?"):
            try:
                result = self.client.delete_channel(
                    self.organization_id,
                    channel_name,
                    self.account_id,
                    funnel_type,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to delete channel: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _view_tactics(self):
        ...
        try:
            result = self.client.get_tactics(
                self.organization_id,
                self.account_id,
                funnel_type,
                funnel_step_num,
    ...
    def _add_tactic(self):
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                result = self.client.create_tactic(
                    self.organization_id,
                    data,
                    self.account_id,
                    funnel_type,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to create tactic: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _edit_tactic(self):
        ...
        # Get current data
        try:
            current_result = self.client.get_tactic(
                self.organization_id,
                tactic_name,
                self.account_id,
                funnel_type,
        ...
        if Confirm.ask(self.SAVE_CHANGES_PROMPT):
            try:
                result = self.client.update_tactic(
                    self.organization_id,
                    tactic_name,
                    data,
                    self.account_id,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to update tactic: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:
    ...
    def _delete_tactic(self):
        ...
        if Confirm.ask("Are you sure you want to delete this tactic?"):
            try:
                result = self.client.delete_tactic(
                    self.organization_id,
                    tactic_name,
                    self.account_id,
                    funnel_type,
                ...
                if result.get("success"):
                    ...
                    console.print(
                        f"[red]Failed to delete tactic: {result.get('detail', 'Unknown error')}[/red]"
                    )
            except Exception as e:

...
class TestFirestoreSecretManagerIntegration:
    ...
    @patch('src.kene_api.firestore.service_account.Credentials.from_service_account_info')
    ...
    def test_initialize_with_secret_manager_service_account(
        ...
        with patch.dict(os.environ, {
            ...
            mock_get_secret_json.assert_called_once_with("GOOGLE_APPLICATION_CREDENTIALS")
    ...
    @patch('src.kene_api.firestore.firestore.Client')
    @patch('src.kene_api.firestore.service_account.Credentials.from_service_account_file')
    ...
    @patch('src.kene_api.firestore.get_env_var_or_secret_json')
    def test_initialize_secret_manager_failure_with_fallback(self, mock_get_secret_json):
...
class TestFirestoreErrorHandling:
    ...
    def test_invalid_json_credentials_format(self):
        ...
        with patch.dict(os.environ, {
            ...
            "GOOGLE_APPLICATION_CREDENTIALS": secret_path,
            "USE_APPLICATION_DEFAULT_CREDENTIALS": "false"
        }), patch('src.kene_api.firestore.get_env_var_or_secret_json') as mock_get_secret:

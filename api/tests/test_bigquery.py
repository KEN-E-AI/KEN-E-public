...
class TestBigQueryService:
    ...
    def test_initialize_with_service_account_file(self):
        ...
        with patch.dict(os.environ, {
            ...
            with patch("os.path.isfile", return_value=True):
                with patch("src.kene_api.bigquery.service_account.Credentials.from_service_account_file") as mock_creds:
                    mock_credentials = Mock()
    ...
    def test_query_holiday_activities_success(self):
        ...
        mock_results = [
            ...
            {"description": "Christmas", "start_date": "2024-12-25", "end_date": "2024-12-26"}
        ]

...
def sample_template_data():
    ...
    return {
        ...
        "default_settings": {"data_retention": 90},
        "is_active": True,
...
class TestListIndustryTemplates:
    ...
    @patch("src.kene_api.routers.industry_templates._fetch_all_templates")
    def test_list_active_only_filters_inactive(
        self, mock_fetch, client, sample_template_data
    ):
    ...
    def test_list_templates_firestore_unavailable(self, mock_fetch, client):
        ...
        mock_fetch.side_effect = HTTPException(
            status_code=503, detail="Firestore service unavailable"
        )
...
class TestGetIndustryTemplate:
    ...
    def test_get_template_by_industry_success(
        self, mock_fetch, client, sample_template_data
    ):
        ...
        # Make request
        response = client.get(
            "/api/v1/industry-templates/industry/Retail%20Trade%20%5BB2C%5D"
        )
    ...
    def test_get_template_by_industry_not_found(self, mock_fetch, client):
        ...
        # Make request
        response = client.get(
            "/api/v1/industry-templates/industry/NonExistent%20Industry"
        )
...
class TestGetTemplateById:
    ...
    def test_get_template_by_id_not_found(
        self, mock_fetch, mock_get_firestore, client, mock_firestore_service
    ):

...
class TestInitializeFirebaseAdmin:
    ...
    def test_initialize_with_application_default_credentials(self):
        ...
        with mock.patch.dict(os.environ, {"USE_APPLICATION_DEFAULT_CREDENTIALS": "true"}):
    ...
    def test_initialize_handles_errors(self):
        ...
        with mock.patch("firebase_admin.get_app", side_effect=ValueError):
            with mock.patch("firebase_admin.initialize_app", side_effect=Exception("Init failed")):
...
class TestVerifyIdToken:
    ...
    def test_verify_valid_token(self):
        ...
        with mock.patch("firebase_admin.auth.verify_id_token", return_value=mock_decoded):

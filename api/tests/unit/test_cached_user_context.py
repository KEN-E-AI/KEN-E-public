...
class TestCachedUserContextService:
    ...
    def cached_service(self):
        ...
        with mock.patch("src.kene_api.auth.cached_user_context.get_redis_service") as mock_get_redis:
    ...
    def test_get_user_context_from_cache(self, cached_service, user_context):
        ...
        cached_service.redis.get_json.assert_called_once_with("user_context:test-user-123")
    ...
    def test_invalidate_user_context_success(self, cached_service):
        ...
        assert result is True
        cached_service.redis.delete.assert_called_once_with("user_context:test-user-123")

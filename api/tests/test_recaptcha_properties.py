...
class TestScoreValidation:
    ...
    def test_score_threshold_property(self, score, min_score):
        ...
        result = RecaptchaVerificationResult(success=True, score=score, action="test")
...
class TestActionValidation:
    ...
    def test_action_matching_property(self, actual_action, expected_action):
        ...
        result = RecaptchaVerificationResult(
            success=True, score=0.9, action=actual_action
        )

        validated = recaptcha_service._validate_v3_response(
            result, expected_action, 0.5
        )
    ...
    def test_no_expected_action_always_passes(self, action):
        ...
        recaptcha_service = create_recaptcha_service()
        result = RecaptchaVerificationResult(success=True, score=0.9, action=action)
...
class TestCombinedValidation:
    ...
    def test_combined_validation_property(
        ...
        recaptcha_service = create_recaptcha_service()
        result = RecaptchaVerificationResult(
            success=True, score=score, action=actual_action
        )

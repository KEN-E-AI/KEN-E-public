...
class TestChangeOrganizationSubscription:
    ...
    async def test_change_subscription_success(
        ...
        sample_organization_data, sample_plan_data
    ):
    ...
    async def test_change_subscription_plan_not_found(
        self, test_app, mock_neo4j_service, mock_firestore_service, sample_organization_data
    ):
    ...
    async def test_change_subscription_database_error(
        ...
        mock_neo4j_service.execute_write_query.side_effect = Exception("Database connection error")

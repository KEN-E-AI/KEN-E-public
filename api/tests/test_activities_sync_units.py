...
class TestCalculateSyncOperations:
    ...
    def test_all_operations(self):
        ...
        bigquery_holidays = [
            {"description": "Holiday1", "start_date": "2024-01-01", "end_date": "2024-01-01"},
            {"description": "Holiday4", "start_date": "2024-04-01", "end_date": "2024-04-01"},
        ]
...
class TestBatchOperations:
    ...
    async def test_delete_batch_success(self):
        ...
        deleted = await _delete_activity_logs_batch(
            mock_db, ["log_1", "log_2"]
        )
...
class TestExecuteSyncOperations:
    ...
    async def test_execute_with_batching(self):
        ...
        create_calls = [call for call in mock_db.execute_write_query.call_args_list 
                       if "logs" in call.kwargs]
        delete_calls = [call for call in mock_db.execute_write_query.call_args_list 
...
@pytest.mark.parametrize("batch_size,total_items,expected_batches", [
    (50, 150, 3),
    (50, 50, 1),
    (50, 49, 1),
    (50, 0, 0),

...
class RedisPerformanceTester:
    ...
    def generate_test_data(self, size: str = "medium") -> dict[str, Any]:
        ...
        if size == "small":
            ...
            return {
                ...
                "monitoring_topics": [f"topic_{i}" for i in range(20)],
            }
        ...
        for size in sizes:
            ...
            for i in range(num_operations // len(sizes)):
                ...
                self.measure_operation(
                    f"json_set_{size}", self.redis_service.set_json, key, data, 600
                )
            ...
            for i in range(num_operations // len(sizes)):
                ...
                self.measure_operation(
                    f"json_get_{size}", self.redis_service.get_json, key
                )
    ...
    def test_concurrent_operations(
        ...
        print(
            f"🧪 Testing concurrent operations ({num_threads} threads, {operations_per_thread} ops/thread)..."
        )
    ...
    def test_cache_patterns(self):
        ...
        for industry in [
            ...
            self.measure_operation(
                "industry_cache_get", self.redis_service.get_json, key
            )
        ...
        for user_id in range(100):
            ...
            self.measure_operation(
                "user_context_set", self.redis_service.set_json, key, user_context, 300
            )
        ...
        for account_id in range(50):
            ...
            self.measure_operation(
                "monitoring_cache_get", self.redis_service.get_json, key
            )

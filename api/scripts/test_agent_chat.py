...
def load_staging_env():
    ...
    print(f"📋 Setting up staging environment variables...")
...
async def test_agent_chat():
    ...
    try:
        ...
        if agent_engine:
            ...
            methods = [method for method in dir(agent_engine) if not method.startswith('_')]
    ...
    # Create test data
    test_messages = [
        ChatMessage(role="user", content="Hello! What can you help me with?", timestamp="2025-01-31T12:00:00Z")
    ]

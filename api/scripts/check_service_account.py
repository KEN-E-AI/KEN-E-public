...
def test_service_account(sa_file_path: str):
    ...
    try:
        credentials = service_account.Credentials.from_service_account_file(
            sa_file_path, scopes=["https://www.googleapis.com/auth/cloud-platform"]
        )
    ...
    try:
        ...
        try:
            ...
            test_secret_name = (
                f"projects/{project_id}/secrets/neo4j-password/versions/latest"
            )
            ...
            try:
                ...
                print(
                    "   The service account can list secrets but cannot access their values"
                )
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        if not test_service_account(sa_file):
            ...
            print("   gcloud projects add-iam-policy-binding 391472102753 \\")
            print("     --member='serviceAccount:YOUR_SERVICE_ACCOUNT_EMAIL' \\")

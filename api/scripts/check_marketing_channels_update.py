...
async def test_marketing_channels_update():
    ...
    async with httpx.AsyncClient() as client:
        ...
        print(f"Current marketing channels: {test_account.get('marketing_channels', [])}")
        ...
        print(f"Updated marketing channels: {updated_account.get('marketing_channels', [])}")
        print(f"Updated product integrations: {updated_account.get('product_integrations', [])}")
        ...
        print(f"Verified marketing channels: {verified_account.get('marketing_channels', [])}")
        print(f"Verified product integrations: {verified_account.get('product_integrations', [])}")
        
        # Check if the update was successful
        if verified_account.get('marketing_channels') == update_data['marketing_channels']:

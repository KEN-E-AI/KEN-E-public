...
1. **Strategy Label**: All strategy-related nodes (Product, ProductCategory, ValueProposition, Strength, Weakness, Opportunity, Risk, Goal) receive TWO labels in Neo4j:
   - Their specific node type label (e.g., `Product`, `ValueProposition`)
...
2. **Bidirectional Relationships**: Several key relationships are created bidirectionally to support efficient graph traversal in both directions:
   - `Account -[:OFFERS_PRODUCTS]-> ProductCategory` AND `ProductCategory -[:BELONGS_TO]-> Account`
   - `Account -[:AFFECTED_BY_ANALYSIS]-> SWOTAnalysis` AND `SWOTAnalysis -[:BELONGS_TO]-> Account`

   All child nodes of an Account (ProductCategory, Product, ValueProposition, Strength, Weakness, Opportunity, Risk, Goal) have a `-[:BELONGS_TO]-> Account` relationship.

3. **SWOT Structure**: The SWOT analysis uses a hub-and-spoke pattern:
   - A central `SWOTAnalysis` hub node connects to the Account
   - Individual Strength and Weakness nodes link to the hub via `HAS_STRENGTH` and `HAS_WEAKNESS` relationships
   - Opportunities link to Strengths via `CREATES` relationships (Strength -> Opportunity)
   - Risks link to Weaknesses via `CREATES` relationships (Weakness -> Risk)
...
| company\_name | string | The refined official company name. This may be updated by strategy agents to provide a more formal or complete version (e.g., "HDFC Bank" -> "HDFC Bank Limited"). | `HDFC Bank Limited` |
...
| ProductCategory | `<-[:OFFERS_PRODUCTS]-` | Account | The Account offers this ProductCategory (bidirectional relationship for efficient traversal). |
...
| references | list | A list of source URLs or document references that support this product information. | `["https://example.com/products"]` |
...
| references | list | A list of source URLs or document references that support this value proposition. | `["https://example.com/about"]` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System generated` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `John Doe` |
...
**SWOTAnalysis**
**Purpose**: Hub node that groups all SWOT analysis components (strengths, weaknesses, opportunities, and risks) for an account. This node serves as an organizational anchor for the SWOT analysis.

| name | type | description | example |
| :--- | :--- | :--- | :--- |
| node\_id | string | A unique identifier for the SWOT Analysis. Generated by the system when a SWOTAnalysis node is created. | `swot_c6051eee55b647ab81a80ffab37295e2` |
| label | string | The node type in neo4j. | `SWOTAnalysis` |
| display\_name | string | A descriptive name for this SWOT analysis. | `SWOT Analysis for acc_c6051eee` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `System` |

**Relationships**
| Label | Relationship | Label | Description |
| :--- | :--- | :--- | :--- |
| SWOTAnalysis | `-[:BELONGS_TO]->` | Account | Each SWOT Analysis belongs to exactly one account. |
| SWOTAnalysis | `<-[:AFFECTED_BY_ANALYSIS]-` | Account | The account is affected by this SWOT analysis (bidirectional relationship for efficient traversal). |
| SWOTAnalysis | `-[:HAS_STRENGTH]->` | Strength | Links to individual strength nodes identified in the analysis. |
| SWOTAnalysis | `-[:HAS_WEAKNESS]->` | Weakness | Links to individual weakness nodes identified in the analysis. |
...
| references | list | A list of source URLs or document references that support this strength analysis. | `["https://example.com/analysis"]` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System generated` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `John Doe` |
...
| references | list | A list of source URLs or document references that support this weakness analysis. | `["https://example.com/analysis"]` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System generated` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `John Doe` |
...
| references | list | A list of source URLs or document references that support this opportunity analysis. | `["https://example.com/trends"]` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System generated` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `John Doe` |
...
| name | type | description | example |
| :--- | :--- | :--- | :--- |
| node\_id | string | A unique identifier for the Risk. Generated by the system when a Risk node is created. | `risk_c6051eee55b647ab81a80ffab37295e2` |
| label | string | The node type in neo4j. | `Risk` |
| label | string | The node type in neo4j. The strategy label is used to indicate that the description for this node can be used to create searchable vector embeddings for a strategy search tool. | `Strategy` |
| display\_name | string | A short name to describe the risk in less than 60 characters. | `Well funded startup competitors` |
...
| references | list | A list of source URLs or document references that support this risk analysis. | `["https://example.com/analysis"]` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System generated` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `John Doe` |
...
| references | list | A list of source URLs or document references that support this strategic goal. | `["https://example.com/strategy"]` |
| created\_time | timestamp | The timestamp when the node was created. | 2025-07-29 22:06:45.928000 UTC |
| last\_modified | timestamp | The timestamp when the node was last modified | 2025-07-29 22:06:45.928000 UTC |
| created\_by | string | Identifies the user who approved the creation of the node, or identifies it as system generated. | `System generated` |
| last\_modified\_by | string | Identifies the user who last modified the node. | `John Doe` |

...
| Modify | `docs/design/automations/automations-implementation-plan.md` — append a "Status: shipped" section at the top with link to this PRD's verification report |
...
7. A short verification report is added to `automations-implementation-plan.md` linking each A-PRD to its verifying test
...
- Parent plan: [`../automations-implementation-plan.md`](../automations-implementation-plan.md) §6 (Verification plan)
...
- Calendar verification reference: [Calendar PRD-5](../../prd/05-integration-testing-and-polish.md)

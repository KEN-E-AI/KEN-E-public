...
- All sibling PRDs: [01](./01-data-model-and-api.md), [02](./02-planning-agent-and-tools.md), [03](./03-calendar-page-frontend.md), [04](./04-event-driven-orchestrator.md), [06](./06-time-based-scheduler.md)

...
**Blocked by:** —
**Parallel with:** Sprint 9, 2.6-A, 2.6-C
**Blocks:** 2.6-B (integration decisions depend on findings)
...
3. Sprint 2.6-B's integration design (whether `scripts/` are a real feature or just read-only reference files) hinges on the answers.

...
> **Design refs:** [Harness §4.3 Tool Discovery](design/../../docs/KEN-E-System-Architecture.md#43-tool-discovery--dynamic-tool-selection) | [Agentic-harness README §2.5](design/components/agentic-harness/README.md#25-tool-assignment--routing-model) | [mcp-architecture §4, §6](design/components/agentic-harness/mcp-architecture.md)
```

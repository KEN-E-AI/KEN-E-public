      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="relative inline-block mb-4">
            <div className="size-24 rounded-full bg-gradient-to-br from-[var(--color-violet-500)] to-[var(--color-blue-500)] flex items-center justify-center"
          ...
          <div className="space-y-4">
            ...
            <div className="p-4 rounded-[var(--radius-md)] bg-[var(--color-bg-elevated)]">
              ...
              <ol className="space-y-2 text-sm text-muted-foreground">
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-violet-500)] font-medium shrink-0">1.</span>
                  <span>Check your inbox for an email from KEN-E</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-violet-500)] font-medium shrink-0">2.</span>
                  <span>Click the verification link in the email</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[var(--color-violet-500)] font-medium shrink-0">3.</span>
            ...
            {resendStatus === 'error' && (
              <div className="p-3 rounded-[var(--radius-md)] bg-red-50 border border-red-200 flex items-center gap-2">
                ...
                <p className="text-sm text-red-600">Failed to resend email. Please try again.</p>
              </div>
            )}

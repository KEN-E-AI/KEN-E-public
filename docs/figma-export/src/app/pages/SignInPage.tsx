...
export function SignInPage() {
  ...
  const invitationType = urlParams.get('type'); // 'organization' or 'account'
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  {inviterName || 'Someone'} invited you to join their {invitationType || 'team'}. Sign in or create an account to accept.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="bg-card rounded-[var(--radius-lg)] border-2 border-[var(--color-border-default)] p-6 shadow-lg">
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-muted-foreground">
              ...
              <Link
                to={invitationToken ? `/create-account?invitation=${invitationToken}&type=${invitationType}&inviter=${inviterName}` : '/create-account'}

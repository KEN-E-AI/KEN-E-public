...
export function Logo({ size = 'md', variant = 'full' }: LogoProps) {
  ...
  return (
    <div className="flex items-center gap-3">
      <div className={`${sizeClasses[size]} shrink-0 transition-transform hover:rotate-0`}
        style={{
      ...
      >
        <svg width="100%" height="100%" viewBox="0 0 256 256" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {/* Tilt group */}
          <g transform="translate(128 128) rotate(-3) translate(-128 -128)" filter="url(#ribbonShadow)">
